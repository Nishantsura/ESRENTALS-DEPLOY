  ...
  return (
    <section className="mt-8 sm:mt-10">
      <div className="flex items-center px-4 sm:px-4 justify-between mb-6 -mx-4">
        ...
        <Link href="/categories" className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-background text-white hover:bg-teal-500 hover:text-white h-10 px-4 py-2">
          View all
        </Link>
      </div>
      <div className="-mx-4">
