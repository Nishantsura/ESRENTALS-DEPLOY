...
export function Header() {
  ...
  return (
    <>
      <header className="py-4 sm:py-5 px-4 sm:px-6 border-b border-border bg-background/80 backdrop-blur-lg sticky top-0 z-50 left-0 right-0 theme-transition">
        <div className='flex flex-row items-center justify-between w-full max-w-[2000px] mx-auto'>
          ...
          <div className="flex items-center gap-4">
            ...
            <a 
              ...
              className="hidden md:flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-full hover:opacity-90 transition-opacity"
            >
      ...
      <div 
        className={`fixed top-0 right-0 h-full w-72 bg-card/95 backdrop-blur-sm shadow-lg transform transition-all duration-300 ease-in-out z-[100] ${
